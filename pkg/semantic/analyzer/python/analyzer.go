...
func (a *PythonAnalyzer) registerFrameworkPatterns() {
	base.RegisterFrameworkPatterns(a.BaseAnalyzer, pythonPatterns.GetAllPatterns(), "")
}
...
func (a *PythonAnalyzer) AnalyzeMethodBody(method *types.MethodDef, source []byte, state *types.AnalysisState) (*analyzer.MethodFlowAnalysis, error) {
	return base.AnalyzeMethodBody(method, state, "", a.inputSources, pythonPatterns.BuildSelfPropertyAssignPattern), nil
}
