...
// cppSpecificDefinitions contains C++-only input source definitions.
var cppSpecificDefinitions = []common.Definition{
		// iostream
		{
			Name:        "std::cin",
...
// Definitions contains all C++ source definitions (C definitions with "cpp" language + C++ specific).
var Definitions = append(c.GetDefinitions("cpp"), cppSpecificDefinitions...)

// NewMatcher creates a new C++ source matcher
func NewMatcher() *Matcher {
	return &Matcher{
		BaseMatcher: common.NewBaseMatcher("cpp", Definitions),
	}
}
