...
// PHPMatcher matches PHP user input sources
type PHPMatcher struct {
	*BaseMatcher
}

// NewPHPMatcher creates a new PHP source matcher
func NewPHPMatcher() *PHPMatcher {
	sources := []Definition{
		// Superglobals - HTTP
		{
			Name:         "$_GET",
		...
		// Database results (common patterns)
		{
			Name:        "mysqli_fetch_array",
			Pattern:     `mysqli_fetch_array\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "MySQL fetch array",
			NodeTypes:   []string{"function_call_expression"},
		},
		{
			Name:        "mysqli_fetch_assoc",
			Pattern:     `mysqli_fetch_assoc\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "MySQL fetch associative",
			NodeTypes:   []string{"function_call_expression"},
		},
		{
			Name:        "mysqli_fetch_row",
			Pattern:     `mysqli_fetch_row\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "MySQL fetch row",
			NodeTypes:   []string{"function_call_expression"},
		},
		{
		...
		},
		{
			...
			Pattern:     `->\s*fetchAll\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "PDO fetch all results",
			NodeTypes:   []string{"member_call_expression"},
		},
		...
		// WordPress specific
		{
			...
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "WordPress database results",
			NodeTypes:   []string{"member_call_expression"},
		},
		{
			Name:        "$wpdb->get_row",
			...
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "WordPress database row",
			NodeTypes:   []string{"member_call_expression"},
		},
		{
			Name:        "$wpdb->get_var",
			...
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "WordPress database variable",
			NodeTypes:   []string{"member_call_expression"},
		},
		{
			Name:        "$wpdb->get_col",
			Pattern:     `\$wpdb\s*->\s*get_col\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "WordPress database column",
			NodeTypes:   []string{"member_call_expression"},
		},
		...
		// Generic database fetch methods (any object, not just mysqli)
		{
			Name:        "->fetch_array()",
			Pattern:     `->\s*fetch_array\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "Generic database fetch array method",
			NodeTypes:   []string{"member_call_expression"},
		},
		{
			Name:        "->fetch_field()",
			Pattern:     `->\s*fetch_field\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "Generic database fetch field method",
			NodeTypes:   []string{"member_call_expression"},
		},
		{
			Name:        "->fetch_row()",
			Pattern:     `->\s*fetch_row\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "Generic database fetch row method",
			NodeTypes:   []string{"member_call_expression"},
		},
		{
			Name:        "->fetch_assoc()",
			Pattern:     `->\s*fetch_assoc\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "Generic database fetch associative method",
			NodeTypes:   []string{"member_call_expression"},
		},
		{
			Name:        "->fetch_object()",
			Pattern:     `->\s*fetch_object\s*\(`,
			Language:    "php",
			Labels:      []InputLabel{LabelDatabase},
			Description: "Generic database fetch object method",
			NodeTypes:   []string{"member_call_expression"},
		},
	...
	return &PHPMatcher{
		BaseMatcher: NewBaseMatcher("php", sources),
	}
}
