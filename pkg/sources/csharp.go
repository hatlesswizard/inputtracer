...
// CSharpMatcher matches C# user input sources
type CSharpMatcher struct {
	*BaseMatcher
}

// NewCSharpMatcher creates a new C# source matcher
func NewCSharpMatcher() *CSharpMatcher {
	sources := []Definition{
		// ASP.NET Core / MVC
		{
			Name:         "Request.Query",
		...
		{
			Name:        "SqlDataReader",
			Pattern:     `SqlDataReader|\.ExecuteReader\s*\(`,
			Language:    "c_sharp",
			Labels:      []InputLabel{LabelDatabase},
			Description: "SQL data reader",
			NodeTypes:   []string{"identifier", "invocation_expression"},
		},
		{
			...
			Language:    "c_sharp",
			Labels:      []InputLabel{LabelDatabase},
			Description: "Get string from data reader",
			NodeTypes:   []string{"invocation_expression"},
		},
		{
			Name:        "DataReader.GetInt32()",
			Pattern:     `\.GetInt32\s*\(`,
			Language:    "c_sharp",
			Labels:      []InputLabel{LabelDatabase},
			Description: "Get int from data reader",
			NodeTypes:   []string{"invocation_expression"},
		},
		{
			Name:        "DataReader[]",
			...
			Language:    "c_sharp",
			Labels:      []InputLabel{LabelDatabase},
			Description: "Data reader indexer",
			NodeTypes:   []string{"element_access_expression"},
		},
	...
	return &CSharpMatcher{
		BaseMatcher: NewBaseMatcher("c_sharp", sources),
	}
}
