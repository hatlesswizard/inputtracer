...
// wordPressExcludedMethods returns WordPress-specific methods that don't return user input.
func wordPressExcludedMethods() map[string]bool {
...
// symfonyPropertyMappings returns the mapping of Symfony Request public properties.
func symfonyPropertyMappings() map[string]*MethodMapping {
	return map[string]*MethodMapping{
